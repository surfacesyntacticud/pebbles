...
# Discourse relation without extension

Discourse words or phrase which are neither filler (like *euh* in French) nor question tags are annotated with the `discourse` relation without subrelations.

The `discourse` relation is used for simple discourse markers such as interjections or adverbs.
...
Ex: *He comes on wednesday, I think.* 
In this sentence *I think* is a discourse marker because it lacks an object (the object of the verb *think* is the rest of the sentence) and because they are fixed (*I think* doesn't commute with *he thinks*).
...
4	peu	peu	NOUN	_	ExtPos=ADV	8	reparandum	_	Gloss=bit|Idiom=Yes
5	euh	euh	INTJ	_	_	4	discourse:filler	_	Gloss=um
6	,	,	PUNCT	_	_	5	punct	_	_
7	un	un	DET	_	Definite=Ind|Gender=Masc|Number=Sing|PronType=Art	8	det	_	Gloss=a|InIdiom=Yes
8	peu	peu	NOUN	_	ExtPos=ADV	9	mod	_	Gloss=bit|Idiom=Yes
...
<conll>
# sent_id = ParisStories_2022_14_râteauAuTravail__38
# speaker = L1
# text = et du coup, les jours passent.
1	et	et	CCONJ	_	_	7	cc	_	AlignBegin=63886|AlignEnd=64061
2	du	du	ADP	_	_	7	discourse	_	AlignBegin=64061|AlignEnd=64237|highlight=red
3	coup	coup	NOUN	_	_	2	comp	_	AlignBegin=64237|AlignEnd=64412|Gender[lex]=Masc|Number[ctxt]=Sing|SpaceAfter=No
4	,	,	PUNCT	_	_	2	punct	_	AlignBegin=64412|AlignEnd=64412
5	les	le	DET	_	Definite=Def|Number=Plur|PronType=Art	6	det	_	AlignBegin=64412|AlignEnd=64588|HasSpokenGender=OnlySingExceptWithLiaison
6	jours	jour	NOUN	_	_	7	subj	_	AlignBegin=64588|AlignEnd=64763|Gender[lex]=Masc|Number[ctxt]=Plur
7	passent	passer	VERB	_	Mood=Ind|Person=3|Tense=Pres|VerbForm=Fin	0	root	_	AlignBegin=64763|AlignEnd=64939|Number[ctxt]=Plur|SpaceAfter=No|highlight=red
8	.	.	PUNCT	_	_	7	punct	_	AlignBegin=64939|AlignEnd=64939
</conll>

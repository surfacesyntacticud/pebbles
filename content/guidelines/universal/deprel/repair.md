...
2	ai	ai~	AUX	_	Number=Sing|Person=1	0	root	_	Gloss=have|highlight=red
3	j'	il	PRON	_	Number=Sing|Person=1|PronType=Prs	4	subj	_	SpaceAfter=No|Gloss=I
4	ai	avoir	AUX	_	Mood=Ind|Number=Sing|Person=1|Tense=Pres|VerbForm=Fin	2	repair	_	Gloss=have|highlight=red
...
5	use	use	VERB	_	_	3	comp	_	AlignBegin=145160|AlignEnd=145448|Gloss=use|Lang=en|Subject=SubjRaising|highlight=red
...
8	wear	wear	VERB	_	_	5	repair	_	AlignBegin=145736|AlignEnd=146024|Gloss=wear|Lang=en|highlight=red
...
2	é~	é~	X	_	_	0	root	_	highlight=red
3	c'	ce	PRON	_	Gender=Masc|Number=Sing|Person=3|PronType=Dem	4	subj	_	Gloss=it
4	était	être	AUX	_	Mood=Ind|Number=Sing|Person=3|Tense=Imp|VerbForm=Fin	2	repair	_	Gloss=was|highlight=red

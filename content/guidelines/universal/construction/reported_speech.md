...
Reported speech has a feature [`Reported=Yes`](guidelines/universal/feature/Reported) on its head.
It is generally the [`comp:obj`](guidelines/universal/deprel/comp/comp:obj) of a speech verb, such as _dire_ 'to say'. 
...
13	avoir	avoir	AUX	_	VerbForm=Inf	11	comp	_	AlignBegin=12715|AlignEnd=12853|Subject=SubjRaising
...
> [!warning]
> Reported speech was previously annotated using the syntactic relation [`parataxis:obj`](guidelines/universal/deprel/deprecated/parataxis:obj), but this is now considered deprecated.
